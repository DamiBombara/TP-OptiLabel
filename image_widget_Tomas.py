...
class ImageWidget(QWidget):
    ...
    def openImage(self):
        ...
        if filename:
            ...
            current_path, file_with_extension = os.path.split(filename)
    ...
    def saveMaskAsPng(self):
        if self.imageLabel.currentMask == "Vessel network":
            ...
            image_path = os.path.join(vessel_folder, self.file_name + "_" + "VesselMask.png")
            ...
            image_path = os.path.join(macula_folder, self.file_name + "_" + "Macula.png")
            ...
            image_path = os.path.join(optical_folder, self.file_name + "_" + "Optical.png")
